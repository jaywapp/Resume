...
export const IntroDesc = [
    ...
    '솔루션 개발은 고객의 문제를 정의하고 문제를 해결하기 위한 과정입니다. 이 과정은 늘 어렵지만 문제 해결의 순간은 항상 달콤합니다. 저는 그 달콤함을 위해 항상 노력합니다.',
    '저는 .NET 개발자 박준영입니다.',
]
...
export const Expes = [
    {
        company : '펜타큐브',
        roles : [
            'Software Developer', 'Tech Leader', 'Prject Leader',
        ],
        enterDate : '2017.03',
        resignDate : '',
        works : [
        ...
        performances : [
            ...
            {
                name : 'Plugin 시스템 구축',
                desc : '하나의 솔루션에 대해 고객사, 부서, 권한에 따라 별도의 기능을 사용하고 싶다는 요구 사항이 있었습니다. 이를 보다 효율적으로 운용하기 위해 Plugin 구조를 구축하여 고객마다 프로젝트를 별도로 유지할 수 있도록 하였습니다. 결과로 목적에 따라 별도의 프로젝트를 운용할 수 있게 되었습니다.',
                summary : [
                    'Plugin Import 구조 구축',
                    '자사 Plugin API 개발',
                ]
